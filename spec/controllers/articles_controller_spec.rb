    ...
    describe "PUT #update" do
     context "valid attributes" do
       it "updates the requested article" do
         user1= User.create(username: 'Frog', email: 'frog@gmail.com', password: 'malutka1')
         article = Article.create(title: 'First', content: '11111111111111111111111111111111111111', user_id: user1.id)
         put :update, params: {id: article.id, article: {title: 'first', content: '11111111111111111111111111111111111111', user_id: user1.id}}
         article.reload
         expect(article.title).to redirect_to('first')
       end
       it "redirects to the article" do
          user1 = User.create(username: 'Frog', email: 'frog@gmail.com', password: 'malutka1')
          article = Article.create(title: 'First', content: '11111111111111111111111111111111111111', user_id: user1.id)
